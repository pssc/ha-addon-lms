# Home Assistant Community Add-on App repo: LMS (formerly Logitech Media Server)
...
This repo can be added directly to the Home Assistant apps repostories for installs of this addon app
