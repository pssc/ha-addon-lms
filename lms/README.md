# Home Assistant Community Add-on App: LMS Lyrion Music Server, Formerly the Logitech Media Server & SqueezeBoxServer
...
This app provides flexible disk layout options, additional customisation of packages and start-up to allow migration of existing setups.  As well as the installation of plugins and dependencies.
An additional related app is available a [squeezelite player](https://github.com/pssc/ha-addon-squeezelite) for the Logitech Media Server.
...
See the [Docs on GitHub](https://github.com/pssc/ha-addon-lms/tree/master/lms/DOCS.md) for all the details, or just install the app and open the Web UI.
...
[release-shield]: https://img.shields.io/badge/version-v9.1.0.0-yellow.svg
