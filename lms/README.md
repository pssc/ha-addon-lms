...
This addon is based on the debian package for version 8.5.0 from https://downloads.slimdevices.com/
...
[release-shield]: https://img.shields.io/badge/version-v8.5.0.0-blue.svg
